...
'''.format(input))
    ...
    with open("../makefiles/"+input+"_Makefile.mk",'w') as wfile2:
        wfile2.write('''include {0}_fastqs.mk
#NOTE: THIS MAKEFILE CANNOT BE RUN WITHOUT RUNNING THE FASTQ.MK FILE FIRST
...
'''.format(input))
    ...
    with open("../PBS/GAGP_jobs/"+input+".pbs",'w') as wfile3:
